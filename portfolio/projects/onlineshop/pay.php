        ...
        <div class="col-lg-12">
            <div class="row">
                ...
                $messageAdmin = "
                    ...
                    $name (with email: $email) has order the following books:<br>
                    $msg <br><br>
                    Total price: $totalPrice kr<br><br>
...
<?php
if ($_SESSION['payPopUp'] == '') {
    include "site/popUpWarn.php";
    $_SESSION['payPopUp'] = 'payPopedUp';
} elseif ($_SESSION['payPopUp'] == 'popedOnce') {
    $_SESSION['payPopUp'] = 'payPopedUp';
}
?>
